...
''' Typical workflow '''
api = PredicSisAPI(token="be047cc75842e8cd6d10c8a8a961311a328528c2e16b3bf6076da1c825efe649", debug=1)
...
scoreset_ids = api.create_score(dictionary_id, model_id, "C:/Users/PC/Documents/projekty/use casy/datasets/and/data.dat", "yes", headers=True)
