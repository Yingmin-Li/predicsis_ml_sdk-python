...
dataset_id = api.create_dataset("C:/Users/PC/Desktop/iris.txt", headers=True)
print("******* " + dataset_id + " *******")
...
scoreset_ids = api.create_score(dictionary_id, model_id, "C:/Users/PC/Desktop/iris.txt", headers=True)
